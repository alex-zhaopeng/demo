...
//        userPermissionArrayList1.add(new UserPermission(1l,"money1"));
//        ArrayList<UserRole> userRoleArrayList1 = new ArrayList<>();
//        userRoleArrayList1.add(new UserRole(1L, "老板", userPermissionArrayList1));
//        UserVo user1 = new UserVo(1l, "admin", "123456", "iwejfiwjf", userRoleArrayList1);
//
...
//        UserVo user2 = new UserVo(2l, "xiaoming", "123456", "jfiosjfos", userRoleArrayList2);
//
//        userList.add(user1);
//        userList.add(user2);
    }
